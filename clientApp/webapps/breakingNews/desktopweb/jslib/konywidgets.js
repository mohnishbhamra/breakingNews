...
$KW.Utils = {
    ...
    getBaseHtml: function(widgetModel, context, type, accessObj, rowIndex) {
        ...
        if(accessAttr.trim().length > 0 && (widgetModel.wType == "Image" || widgetModel.wType == "Switch" || widgetModel.wType == "Link" || widgetModel.wType == "Label" || widgetModel.wType == "RichText" && widgetModel.wType != "ScrollBox")) {
            accessAttr += " tabindex='0'";
        }

        return accessAttr + " id='" + id + "' kwidgettype='" + widgetModel.wType + "' kformname='" + widgetModel.pf + "'" + (tabpaneID && " ktabpaneid='" + tabpaneID + "'") + kmasterObj.kmasterid + (tabID && " ktabid='" + tabID + "'") + (containerID && " kcontainerID = '" + containerID + "'") + (contextmenu && " kcontextmenuid = '" + contextmenu.id + "'") + disable + (toolTip ? " title= '" + toolTip + "'" : "") + hoverString + " ";
    },
    ...
    updateChildModel: function(childModel, data) {
        ...
        if(data instanceof Object) {
            var isGroupWidget = (childModel.wType == "RadioButtonGroup" || childModel.wType == "ComboBox" || childModel.wType == "CheckBoxGroup" || childModel.wType == "ListBox");
            if(isGroupWidget) {
                childModel.masterdata = "";
                childModel.masterdatamap = "";
                if(childModel.wType == "RadioButtonGroup" || childModel.wType == "ComboBox") {
    ...
    scrollToElement: function(widgetModel, el) {
        ...
        var focusElement = el;
        var parentModel = $KG.allforms[widgetModel.pf];
