...
$KW.TabPane = (function() {
    ...
    var module = {
        ...
        generateTabView: function(tabPaneModel,context,updateViewFlag){
            ...
            var tabId;
            var marginPadding = $KW.skins.getMarginSkin(tabPaneModel, context) + $KW.skins.getPaddingSkin(tabPaneModel);
            if(!updateViewFlag)
                htmlString += "<div id = '" + paneId + "' class='" + css + "' style='" + marginPadding + "' kformname='" + tabPaneModel.pf + "' kwidgettype='TabPane' "+kmasterid+">";
        ...
        generateTabViewLi: function(tabPaneModel,tabModel,index){
            ...
            if(tabModel.header){
                ...
                if(tabModel.tabname){
                    htmlString += kony.appinit.isIE? "<div kwidgettype " : "<div ";
                    if(tabModel.image)
        ...
        generateCollapsibleView: function(tabPaneModel, context, updateViewFlag){
            ...
            if(!updateViewFlag){
                var marginPadding = $KW.skins.getMarginSkin(tabPaneModel, context) + $KW.skins.getPaddingSkin(tabPaneModel);
                htmlString += "<div class='" + css + "' style='" + marginPadding + "' id = '" + tabPaneId + "' kformname='" + tabPaneModel.pf + "' kwidgettype='TabPane' "+kmasterObj.kmasterid+">";
            }
        ...
        updateData: function(childModel, childNode, tabPaneModel, row, canExecute, updateMasterData){
            if(tabPaneModel && row){
                ...
                if(canExecute){
                    eventExecuted = kony.events.executeBoxEvent(childModel);
                }
