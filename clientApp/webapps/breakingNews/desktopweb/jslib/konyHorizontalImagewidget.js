    ...
    var module = {
        ...
        render: function(stripModel, context) {
            ...
            if(view == "slotview") {
                ...
                htmlString += "<div id='" + wID + "_scroller' class='kwt100 scrollerX'><div id='" + wID + "_scrollee' class='scrolleeX' " + (kony.appinit.isFirefox ? "style='overflow:hidden'" : "") + ">";
        ...
        generateImages: function(action, imageViewModel, masterdata, index, key, addAllIndex) {
            ...
            if(imageViewModel.wType == "IGallery")
                rcPerPage = rcPerPage * imageViewModel.noofrowsperpage;
            ...
            for(var i = IndexJL; i < (masterdata.length); i++) {
                ...
                if(src) {
                    ...
                    if(imageViewModel.wType == "IGallery" && (i - IndexJL) % (rcPerPage / imageViewModel.noofrowsperpage) == 0 && view == "pageview") {
                    ...
                    htmlString += (kony.appinit.isFirefox || kony.appinit.isIE) ? " ondragstart='return false;'" : ""; 
                    if(isWaitAllowed)
                        style += "opacity:0;";
                    htmlString += (style ? ("style= '" + style + "'") : "") + " /></span>";

                    if(imageViewModel.wType == "IGallery" && ((i + reccount) % (rcPerPage / imageViewModel.noofrowsperpage) == 0 || i == size - 1) && view == "pageview") {
                        htmlString += "</div>";
                    }
        ...
        generateSlotFooter: function(imageStripModel, compskin) {
            var htmlString = "";
            var style = "";
            imageStripModel.paginationconfig = {
                vdistance: "100",
                hdistance: "25",
                leftimageurl: "rotate-left-slotfooter.png",
                rightimageurl: "rotate-right-slotfooter.png"
            }
            imageStripModel.paginationconfig.leftimageurl = imageStripModel.leftarrowimage;
            imageStripModel.paginationconfig.rightimageurl = imageStripModel.rightarrowimage;
