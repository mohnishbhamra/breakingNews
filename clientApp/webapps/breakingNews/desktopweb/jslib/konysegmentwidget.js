...
$KW.Segment = (function() {
    ...
    var module = {
        ...
        generateSegment: function(segmentModel, context) {
            ...
            var widgetSkin = (segmentModel.name == "kony.ui.SegmentedUI2") ? (segmentModel.widgetskin ? segmentModel.widgetskin : "") : (skin ? skin : "");
            ...
            if(pageView) {
                ...
                htmlString += "<div" + $KW.Utils.getBaseHtml(segmentModel, context);
                htmlString += "class='" + computedSkin + "' style='" + margin + padding + "'>";
            }
        ...
        renderHBox: function(widgetModel, context, rowData, segmentModel, rowIndex) {
            ...
            if(topLevelBox) {
                ...
                computedSkin += " " + $KW.skins.getWidgetAlignmentSkin(widgetModel);
                style = $KW.skins.getMarginSkin(widgetModel, context) + $KW.skins.getPaddingSkin(widgetModel);
            }
            htmlString += "<div class = 'ktable " + computedSkin + "'" + $KW.Utils.getBaseHtml(widgetModel, context) + "style='" + style + "'><div class = 'krow " + layoutDirection + " kwt100' >";
        ...
        renderVBox: function(widgetModel, context, rowData, segmentModel, rowIndex) {
            ...
            if(topLevelBox) {
                ...
                htmlString += "<div  class = 'kwt100 kbasemargin ktable'" + $KW.Utils.getBaseHtml(widgetModel, context) + " style='" + segmentPadding + "'>";
            } else {
                ...
                htmlString += "<div class = ' ktable " + computedSkin + "'" + $KW.Utils.getBaseHtml(widgetModel, context) + "style='" + style + "'>";
            }
    ...
    registerScrollEvents: function(segmentModel) {
        ...
        segmentModel.scrolldirection = kony.flex.SCROLL_VERTICAL;
