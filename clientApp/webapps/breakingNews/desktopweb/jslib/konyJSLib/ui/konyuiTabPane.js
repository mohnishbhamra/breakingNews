...
kony.ui.TabPane.prototype.addTab = function(tabId, tabName, tabImage, box, masterDataLoad) {
    ...
    if(arguments.callee.arguments.length == 3) {
        ...
        kony.ui.Form2.prototype.createFormLevelHierarchy.call(widgetref.header, [widgetref.header]);
        widgetref.header.isheader = true;
        kony.ui.ContainerWidget.prototype.createhierarchy.call(widgetref.header, widgetref.header.ownchildrenref);
    } else {
        widgetref = box;
        widgetref.id = tabId;
