...
kony.ui.ImageGallery2 = function(bconfig, lconfig, pspconfig) {
    ...
    this.noofrowsperpage = pspconfig.noofRowsPerPage || 1;
    ...
    defineSetter(this, "noofRowsPerPage", function(val) {
        this.noofrowsperpage = val;
        $KW[this.wType]["updateView"](this, "noofrowsperpage", val);
    });
