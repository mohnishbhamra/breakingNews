...
kony.ui.Popup = function(bconfig, lconfig, pspconfig) {
    ...
    this.draggable = pspconfig.draggable;
    this.resizable = pspconfig.resizable;
    this.minimizeonlostfocus = pspconfig.minimizeOnLostFocus;
    this.retaindisplayonlostfocus = pspconfig.retainDisplayOnLostFocus;
    var config = pspconfig.titleBarConfig;
    if(config) {
        this.titlebarconfig = {};
        this.titlebarconfig.minicon = config.minIcon;
        this.titlebarconfig.maxicon = config.maxIcon;
        this.titlebarconfig.closeicon = config.closeIcon;
        this.titlebarconfig.skin = config.titleBarSkin;
    }
...
kony.ui.Popup.prototype.setGetterSetter = function() {
    ...
    defineSetter(this, "retainDisplayOnLostFocus", function(val) {
        this.retaindisplayonlostfocus = val;
    });
    defineGetter(this, "containerHeight", function() {
        return this.containerheight;
    });
