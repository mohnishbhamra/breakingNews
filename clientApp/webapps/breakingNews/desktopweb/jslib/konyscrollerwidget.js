    ...
    var module = {
        ...
        initializePageViews: function(formId) {
            ...
            if($KG["disableTransition"])
                return;
            var swipeElements = document.querySelectorAll("#" + formId + " div[name='touchcontainer_HStrip'], #" + formId + " div[name='touchcontainer_Segment'], #" + formId + " div[name='touchcontainer_Tabpane']");
