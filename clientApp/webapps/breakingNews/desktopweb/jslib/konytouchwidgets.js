    ...
    var module = {
        ...
        pageviewScroller: function(element, options) {
            ...
            if('ontouchstart' in window)
                ...
                kony.events.addEventListener(element, "mousedown", this.handleEventListener);
            }
        ...
        konyScroller: function(el, options) {
            ...
            if(that.options.useTransform) {
                ...
                if(kony.appinit.isFirefox || kony.appinit.isOpera) {
            ...
            if(!that.options.disableUserScroll) {
                if($KU.isTouchSupported) 
                    ...
                    kony.events.addEventListener(that.scroller, "mousedown", that.handleEventListener);
                    kony.events.addEventListener(that.scroller, "mouseout", that.handleEventListener);
                }
            }
            ...
            if($KU.isOrientationSupported && !$KU.isAndroid) {
                ...
                kony.events.addEventListener(window, "resize", that.handleEventListener);
            }
        ...
        TouchEvents: function(widgetModel, widgetNode, eventType, callback) {
            ...
            if(callback || eventType == 'scroll') {
                ...
                if(eventType == "scroll") {
                    ...
                    kony.events.addEventListener(widgetNode, mouseEvent, this.handleEventListener, false);
